...
Take one down and pass it around, 88 bottles of beer on the wall.".Trim();
        ...
        public void TestVerse2()
        {
            ...
            var actual = sut.Verse(2);

            var expected = @"
2 bottles of beer on the wall, 2 bottles of beer.
Take one down and pass it around, 1 bottle of beer on the wall.".Trim();
        ...
        public void TestVerse1()
        {
            ...
            var actual = sut.Verse(1);

            var expected = @"
1 bottle of beer on the wall, 1 bottle of beer.
Take it down and pass it around, no more bottles of beer on the wall.".Trim();
...
Take one down and pass it around, 97 bottles of beer on the wall.".Trim();
